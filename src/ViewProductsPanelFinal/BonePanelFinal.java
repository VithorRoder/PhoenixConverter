...
public class BonePanelFinal extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/png/bone.png"))); // NOI18N
    ...
    private void carregarDadosDoBanco(int id) {
        String sql = "SELECT * FROM bone WHERE id = ?";
    ...
    private double setPrecoMin(int id) {
        String sql = "SELECT valor_min FROM bone WHERE id = ?";
